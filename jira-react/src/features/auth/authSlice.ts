...
export const fetchAsyncMyProf = createAsyncThunk("auth/loginuser", async () => {
...
export const createAsyncProfile = createAsyncThunk(
  "auth/createProfile",
  async () => {
...
export const updateAsyncProf = createAsyncThunk(
  "auth/updateProf",
